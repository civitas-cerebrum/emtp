...
def run_url_retrieval(questions_file='qa_questions.json', output_dir='dataset/acquisition/temp/urls', verbose: bool = False):
    ...
    retrieve_url_stage(output_dir=output_dir, questions_file=questions_file, verbose=verbose)
...
def run_screenshot_processing(input_dir='dataset/acquisition/temp/screenshots', output_dir='dataset/acquisition/temp/text_data', verbose: bool = False):
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            # URL Retrieval
            questions_file = get_path_input("Questions file path", "qa_questions.json")
            ...
            run_screenshot_processing(input_dir, output_dir, verbose=verbose_logging)
            ...
            run_screenshot_processing(screenshots_temp, final_text_output, verbose=verbose_logging)
